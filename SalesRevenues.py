...
# ----------------------------------------------------------------------
# 4. ส่วนเชื่อมต่อและดึงข้อมูล (โหมด Excel แท้ + Chunking + Retry)
# ----------------------------------------------------------------------
logging.info(f"--- [!] เริ่มการทำงาน (โหมด: SalesRevenues + Retry System) ---")
...
for attempt in range(1, MAX_RETRIES + 1):
    try:
        ...
        with pyodbc.connect(connection_string) as connection:
            ...
            # ✅ Chunking: ทยอยดึงทีละ 50,000 แถว
            chunk_size = 50000
            ...
            if total_rows > 0:
                ...
                # ถ้าไม่พบข้อมูล ก็ถือว่าไม่ Error ให้จบงานได้เลย
