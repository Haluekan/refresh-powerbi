...
# ที่อยู่ของไฟล์ Log
log_file_path = r"D:\OneDrive - Datamars SA\General - IT (Datamars Thailand)\8. Power Platform\Power BI\DATA\data AHDS\WO_log.log"

# ที่อยู่ของไฟล์ Excel
output_file_path = r"D:\OneDrive - Datamars SA\General - IT (Datamars Thailand)\8. Power Platform\Power BI\DATA\data AHDS\WO_Detail.xlsx"

# ชื่อชีตที่คุณต้องการ
your_sheet_name = "vw_WO_Detail" 
...
# ----------------------------------------------------------------------
view_name = "vw_WO_Detail"
sql_query = f"SELECT * FROM {view_name};" 

# ----------------------------------------------------------------------
# 4. ส่วนเชื่อมต่อและดึงข้อมูล (พร้อมระบบ Retry Loop)
# ----------------------------------------------------------------------
logging.info(f"--- [!] เริ่มการทำงาน (โหมด: WO_Detail Excel + Retry + Chunking) ---")
