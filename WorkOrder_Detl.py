...
# ที่อยู่ของไฟล์ Log
log_file_path = r"D:\OneDrive - Datamars SA\General - IT (Datamars Thailand)\8. Power Platform\Power BI\DATA\export data\logfile\WorkOrder_Detllog.log"

# ที่อยู่ของไฟล์ Excel
output_file_path = r"D:\OneDrive - Datamars SA\General - IT (Datamars Thailand)\8. Power Platform\Power BI\DATA\export data\WorkOrder_Detl.xlsx"

# ชื่อชีตที่คุณต้องการ
your_sheet_name = "vw_WorkOrder_Detl" 
...
# ----------------------------------------------------------------------
view_name = "vw_WorkOrder_Detl"
sql_query = f"SELECT * FROM {view_name};" 

# ----------------------------------------------------------------------
# 4. ส่วนเชื่อมต่อและดึงข้อมูล (พร้อมระบบ Retry Loop)
# ----------------------------------------------------------------------
logging.info(f"--- [!] เริ่มการทำงาน (โหมด: WorkOrder_Detl Excel + Retry + Chunking) ---")
